...
// Add Select component if not present - check components/ui/select.tsx
// If missing, we'll use a simpler button-based approach
...
- Sort dropdown for date/name sorting
- Clear filters button when filters active
- URL state via nuqs for shareable filter URLs
  </action>
