...
6. Wrap each card item in a div with:
   ...
   - Transition classes: `transition-[opacity,transform] duration-[var(--duration-entrance)] ease-[var(--ease-smooth)]`
...
- Duration ceiling: ~200-250ms max. Use var(--duration-entrance) (250ms, defined in Plan 12-01) for entrance transition duration, NOT var(--duration-base) (300ms).
  </action>
