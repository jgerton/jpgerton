...
5. Verify the site loads correctly on http://localhost:3400 (no visual regressions)
6. Optional: Run Lighthouse SEO audit on the home page (should score 95+, likely 100 given existing Core Web Vitals)
...
- User verifies OG image appearance, robots.txt content, and overall site health
